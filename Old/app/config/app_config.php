...
// Tableaux de bord BI (liens externes)
$BI_DASHBOARDS = [
    [
        'label' => 'Power BI - Épidémiologie',
        'description' => 'Analyse des tendances épidémiologiques du choléra en RDC',
        'url' => 'https://app.powerbi.com/...' // À remplacer par votre URL
    ],
    [
        'label' => 'Tableau - Surveillance',
        'description' => 'Suivi des indicateurs de surveillance et des alertes',
        'url' => 'https://public.tableau.com/...' // À remplacer par votre URL
    ],
    [
        'label' => 'Metabase - Dashboard',
        'description' => 'Visualisation des données opérationnelles',
        'url' => 'http://localhost:3000' // À remplacer par votre URL
    ],
    [
        'label' => 'Superset - Choléra',
        'description' => 'Exploration avancée des données épidémiologiques',
        'url' => 'http://localhost:8088' // À remplacer par votre URL
    ]
];
